 ...
 * @author ellei
 */
public class Grades1 extends javax.swing.JPanel {

    /**
     * Creates new form Grades1
     */
    public Grades1() {
        initComponents();
    }
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            JFrame frame = new JFrame("Grades1");
            frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
            frame.setContentPane(new Grades1()); // Add the panel to the frame
